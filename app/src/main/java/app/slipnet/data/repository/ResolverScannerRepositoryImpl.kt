...
class ResolverScannerRepositoryImpl @Inject constructor(
    ...
    private suspend fun scanResolverDnsTunnel(
        ...
        // For tunnel subdomains like "t.snappaio.xyz", queries hit the DNSTT server
     ...
     * "t.snappaio.xyz", the NS delegation records live in the parent zone
     * "snappaio.xyz" — querying the tunnel subdomain itself would hit the
    ...
    private suspend fun testNsDelegation(
        ...
        try {
            ...
            // the tunnel subdomain is defined (e.g. NS for "snappaio.xyz" holds
            // the delegation "t.snappaio.xyz NS ns.snappaio.xyz").
